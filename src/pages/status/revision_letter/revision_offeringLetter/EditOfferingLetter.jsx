...
import {
  ...
  AsyncRevisiLetter,
  AsyncApproveLetter,
} from "../../../../state/offering/middleware";
...
const EditOfferingLetter = () => {
  ...
  const cleanedRevisi = revisi.filter(
    (value) =>
      value !== undefined &&
      value !== null &&
      value.trim() !== null &&
    ...
    <div className="container" style={{ paddingBottom: "50px" }}>
      <div className={Style.CreateLetter}>
        ...
        <div style={{ width: "26%" }}>
          ...
          {dataOL.status === "submitted" &&
            showRevisiForm === false &&
            auth.role === "PIC" && (
              <Button
                type="button"
                className={`text-bg-danger ${Style.btnApprove}`}
