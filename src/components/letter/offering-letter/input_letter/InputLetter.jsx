...
const InputOfferingLetter = ({
  ...
  const [isDisabled, setIsDisabled] = useState(
    editLetter && auth.role !== "Admin" && auth.role !== "Sysadmin"
      ? true
      : false
  );

  const productCode = Products.categories
    .find((cat) => cat.name === letterData.category)
    ?.subcategories.find(
      (subCat) => subCat.name === letterData.sub_category
    )?.code;
  ...
  useEffect(() => {
    if (!isUpload & letterData.tanggal_surat && productCode) {
      setLetterData({
        ...letterData,
        nomor_surat: `OL${productCode}-20015-${dateLetter}`,
      });
    }
  ...
  const handleJumlahPenawaranChange = (e) => {
    ...
    setLetterData((prevLetterData) => ({
      ...
      penawaran_forms: Array.from(
        { length: newValue },
        (_, index) =>
          prevLetterData.penawaran_forms[index] || {
            jenisPenawaran: "",
            durasi: "",
            biaya: "",
          }
        ...
        <Form.Group controlId={`biaya-${index}`} className="mb-2">
          ...
          <InputGroup className="mb-3">
            ...
            <Form.Control
              ...
              value={form.biaya}
              onChange={(e) =>
                handlePenawaranFormsChange(index, "biaya", e.target.value)
              }
            />
          </InputGroup>
        </Form.Group>
    ...
    <div className={Style.inputLetter}>
      <Form className={Style.formInputLetter} onSubmit={handleSubmit}>
        <Form.Group controlId="infromasiSurat" className="mb-2">
          ...
          {isUpload && (
            <Form.Group controlId="nomor_surat" className="mb-2">
              ...
              <Form.Control
                ...
                onChange={(e) => {
                  setLetterData({ ...letterData, nomor_surat: e.target.value });
                }}
              />
            </Form.Group>
          )}
          <Form.Group controlId="namaPenerbit" className="mb-2">
            ...
            <Form.Control
              ...
              onChange={(e) => {
                setLetterData({ ...letterData, nama_penerbit: e.target.value });
          ...
          <Form.Group controlId="tanggalSurat" className="mb-2">
            ...
            <Form.Control
              ...
              onChange={(e) => {
                setLetterData({ ...letterData, tanggal_surat: e.target.value });
              }}
            />
          </Form.Group>
          <Form.Group controlId="subject" className="mb-2">
            ...
            <Form.Control
              ...
              onChange={(e) => {
                setLetterData({ ...letterData, perihal: e.target.value });
              }}
            />
          </Form.Group>
          <Form.Group controlId="mediaReferensi" className="mb-2">
            ...
            <Form.Control
              ...
              onChange={(e) => {
                setLetterData({ ...letterData, media_ref: e.target.value });
              }}
            />
          </Form.Group>
          <Form.Group controlId="tanggalReferensi" className="mb-2">
            ...
            <Form.Control
              ...
              onChange={(e) => {
                setLetterData({ ...letterData, tanggal_ref: e.target.value });
              }}
            />
          </Form.Group>
          <Form.Group controlId="jenisPermohonan" className="mb-2">
            ...
            <Form.Control
              ...
              onChange={(e) => {
                setLetterData({
                  ...letterData,
                  jenis_permohonan: e.target.value,
                });
              }}
            />
          </Form.Group>
          <Form.Group controlId="catatan" className="mb-2">
            ...
            <Form.Control
              ...
              onChange={(e) => {
                setLetterData({ ...letterData, catatan: e.target.value });
              }}
            />
          </Form.Group>
        </Form.Group>
        ...
        <Form.Group controlId="informasiCustomer" className="mb-2">
          ...
          <Form.Group controlId="namaTertuju" className="mb-2">
            ...
            <Form.Control
              ...
              onChange={(e) => {
                setLetterData({ ...letterData, nama_tertuju: e.target.value });
              }}
            />
          </Form.Group>
          <Form.Group controlId="jabatan" className="mb-2">
            ...
            <Form.Control
              ...
              onChange={(e) => {
                setLetterData({ ...letterData, jabatan: e.target.value });
              }}
            />
          </Form.Group>
        ...
        <Form.Group controlId="informasiProduk" className="mb-2">
          ...
          <Form.Group controlId="kategoriProduk" className="mb-2">
            ...
            <Form.Select
              ...
              onChange={(e) => {
                setLetterData({ ...letterData, category: e.target.value });
              }}
            >
          ...
          <Form.Group controlId="subCategory" className="mb-2">
            ...
            <Form.Select
              ...
              onChange={(e) => {
                setLetterData({ ...letterData, sub_category: e.target.value });
              }}
            >
              <option>Open this select menu</option>
              {Products.categories
        ...
        <div style={{ display: "flex", justifyContent: "flex-end" }}>
          {(((auth.role === "Admin" || auth.role === "Sysadmin") &&
            editLetter) ||
            !editLetter) && (
